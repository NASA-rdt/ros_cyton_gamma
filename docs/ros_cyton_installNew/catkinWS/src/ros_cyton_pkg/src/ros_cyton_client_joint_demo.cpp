...
//
/// @file ros_cyton_client_joint_demo.cpp
//
//------------------------------------------------------------------------------
...
// %EndTag(LOOP_RATE)%
  ...
  while (ros::ok())
  {
     ...
     ///Joint Mode
     double joint_val1[7]={0.4,1.35,-0.995,-1.4,-0.7,-1.01,-0.139};
     Send_Joint_Pose(joint_val1);
     ...
     double joint_val2[7]={0.2,-1.35,-0.995,1.4,-0.7,-1.01,-0.139};
     Send_Joint_Pose(joint_val2);
