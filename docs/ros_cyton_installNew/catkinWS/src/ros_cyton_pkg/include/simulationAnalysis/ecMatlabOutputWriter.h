#ifndef ecMatlabOutputWriter_H_
#define ecMatlabOutputWriter_H_
//------------------------------------------------------------------------------
// Copyright (c) 2006-2013 Energid Technologies. All rights reserved.
//
/// @file ecMatlabOutputWriter.h
/// @class EcMatlabOutputWriter
/// @brief A class for writing simulation outputs to files in MATLAB
///        format.
//
//------------------------------------------------------------------------------
...
/** A class for writing simulation outputs to files in MATLAB format.
*/
class EC_ACTIN_SIMULATIONANALYSIS_DECL EcMatlabOutputWriter : public EcBaseOutputWriter
{
public:
   /// default constructor
   EcMatlabOutputWriter
      (
      );

   /// destructor
   virtual ~EcMatlabOutputWriter
      (
      );
   ...
   EcMatlabOutputWriter
      (
      const EcMatlabOutputWriter& orig
      );

   /// assignment operator
   EcMatlabOutputWriter& operator=
      (
      const EcMatlabOutputWriter& orig
      );
   ...
   */
   ...
   /// get a null object
   static EcMatlabOutputWriter nullObject
      (
      );
...
protected:
   ...
   /// a string containing the format descriptor "MATLAB"
   static const EcString      m_TheFormatDescriptor;

   /// a string containing the file extension for MATLAB format (.m)
   static const EcString      m_TheFileExtension;
};

#endif // ecMatlabOutputWriter_H_
