#ifndef ecPerumpralExcavationInteraction_H_
#define ecPerumpralExcavationInteraction_H_
//------------------------------------------------------------------------------
// Copyright (c) 2004-2013 Energid Technologies. All rights reserved.
//
/// @file ecPerumpralExcavationInteraction.h
/// @class EcPerumpralExcavationInteraction
/// @brief Defines a class for computing bucket excavation force
///        using Perumpral model
//
//------------------------------------------------------------------------------
...
/// Defines a class for computing bucket excavation force using Perumpral model
class EC_ACTIN_SOILMECHANICS_DECL EcPerumpralExcavationInteraction : public EcBaseExcavationInteraction
{
public:
   /// default constructor
   EcPerumpralExcavationInteraction
      (
      );

   /// destructor
   virtual ~EcPerumpralExcavationInteraction
      (
      );
   ...
   EcPerumpralExcavationInteraction
      (
      const EcPerumpralExcavationInteraction& orig
      );

   /// assignment operator
   EcPerumpralExcavationInteraction& operator=
      (
      const EcPerumpralExcavationInteraction& orig
      );
   ...
   /// get an empty object
   static EcPerumpralExcavationInteraction nullObject
      (
      );
...
#endif // ecPerumpralExcavationInteraction_H_
