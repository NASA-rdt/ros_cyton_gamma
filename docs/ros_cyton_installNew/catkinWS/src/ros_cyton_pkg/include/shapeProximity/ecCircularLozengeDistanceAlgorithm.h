#ifndef EcCircularLozengeDistanceAlgorithm_H_
#define EcCircularLozengeDistanceAlgorithm_H_
//------------------------------------------------------------------------------
// Copyright (c) 2011-2013 Energid Technologies. All rights reserved.
//
/// @file ecCircularLozengeDistanceAlgorithm.h
/// @class EcCircularLozengeDistanceAlgorithm
/// @brief class for distance algorithm involving circular lozenge
//
//------------------------------------------------------------------------------
...
class EC_FOUNDATION_SHAPEPROXIMITY_DECL EcCircularLozengeDistanceAlgorithm : public EcDistanceAlgorithm
{
public:
...
#endif // EcCircularLozengeDistanceAlgorithm_H_
