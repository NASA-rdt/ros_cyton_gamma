#ifndef ecConeDistanceAlgorithm_H_
#define ecConeDistanceAlgorithm_H_
//------------------------------------------------------------------------------
// Copyright (c) 2003-2013 Energid Technologies. All rights reserved.
//
/// @file ecConeDistanceAlgorithm.h
/// @class EcConeDistanceAlgorithm
/// @brief class for distance algorithm involving cone
//
//------------------------------------------------------------------------------
...
class EC_FOUNDATION_SHAPEPROXIMITY_DECL EcConeDistanceAlgorithm : public EcDistanceAlgorithm
{
public:
...
#endif // ecConeDistanceAlgorithm_H_
