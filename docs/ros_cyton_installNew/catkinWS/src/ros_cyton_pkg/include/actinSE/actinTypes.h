...
#    if defined(WIN32)
// Available on both 32- and 64-bin Windows systems
typedef unsigned __int32          EcU32;              ///< 32-bit unsigned integer
typedef __int32                   EcInt32;            ///< 32-bit signed integer
...
#if WIN32 && ( \
   defined(actinSE_actinSE_EXPORTS) || \
   defined(actinSE_actinSENetwork_EXPORTS) || \
   defined(actinSE_remoteCommands_EXPORTS) \
   )
