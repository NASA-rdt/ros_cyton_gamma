#ifndef ecQuadFixedSliderJointCBObject_H_
#define ecQuadFixedSliderJointCBObject_H_
//------------------------------------------------------------------------------
// Copyright (c) 2007-2013 Energid Technologies. All rights reserved.
//
/// @file ecQuadFixedSliderJointCBObject.h
//
//------------------------------------------------------------------------------
...
/**
Holds a description of an object connecting points C and B of a quadrilateral joint type with fixed slider.
*/
class EC_FOUNDATION_MANIPULATOR_DECL EcQuadrilateralFixedSliderJointCBObject : public EcBaseGeneralBoundObject
{
public:
   /// default constructor
   EcQuadrilateralFixedSliderJointCBObject
      (
      );

   /// destructor
   virtual ~EcQuadrilateralFixedSliderJointCBObject
      (
      );
   ...
   EcQuadrilateralFixedSliderJointCBObject
      (
      const EcQuadrilateralFixedSliderJointCBObject& orig
      );

   /// assignment operator
   EcQuadrilateralFixedSliderJointCBObject& operator=
      (
      const EcQuadrilateralFixedSliderJointCBObject& orig
      );
...
#endif // ecQuadFixedSliderJointCBObject_H_
