...
enum StateTypeEnum
{
   JointAngleInRadians  = 0x001, ///< Command joint angle
   BiasAngleInRadians   = 0x002, ///< Bias angle applied to joint
   MinAngleInRadians    = 0x004, ///< Minimum jont angle
   MaxAngleInRadians    = 0x008, ///< Maximum joint angle
