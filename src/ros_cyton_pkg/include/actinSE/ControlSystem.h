...
public:
   ...
   enum ParamTypeEnum
   {
      ...
      JointAngle,        ///< (SG, #EcRealVector) vector of joint angles
      JointPose,         ///< (SG, actinSE::Array3,
                         ///<      actinSE::Orientation,
                         ///<      actinSE::CoordinateSystemTransformation)
                         ///<      Joint position, orientation or both
      JointVelocity,     ///< (SG, #EcRealVector) vector of joint velocities
      ...
      EndEffectorSet,    ///< (S , #EcU32) Set current EE set index
      ControlDescriptor, ///< (S , #EcU32) Set current descriptor index
   };
