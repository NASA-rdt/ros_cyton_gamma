#ifndef ecTetrahedronDistanceAlgorithm_H_
#define ecTetrahedronDistanceAlgorithm_H_
//------------------------------------------------------------------------------
// Copyright (c) 2003-2013 Energid Technologies. All rights reserved.
//
/// @file ecTetrahedronDistanceAlgorithm.h
/// @class EcTetrahedronDistanceAlgorithm
/// @brief class for distance algorithm involving Tetrahedron
//
//------------------------------------------------------------------------------
...
class EC_FOUNDATION_SHAPEPROXIMITY_DECL EcTetrahedronDistanceAlgorithm : public EcDistanceAlgorithm
{
public:
...
#endif // ecTetrahedronDistanceAlgorithm_H_
