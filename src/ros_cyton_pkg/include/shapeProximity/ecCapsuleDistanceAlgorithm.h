#ifndef ecCapsuleDistanceAlgorithm_H_
#define ecCapsuleDistanceAlgorithm_H_
//------------------------------------------------------------------------------
// Copyright (c) 2003-2013 Energid Technologies. All rights reserved.
//
/// @file ecCapsuleDistanceAlgorithm.h
/// @class EcCapsuleDistanceAlgorithm
/// @brief class for distance algorithm involving capsule
//
//------------------------------------------------------------------------------
#include <foundation/foundation_config.h>  // Required to be first header.
#include "ecDistanceAlgorithm.h"

class EC_FOUNDATION_SHAPEPROXIMITY_DECL EcCapsuleDistanceAlgorithm : public EcDistanceAlgorithm
{
public:
...
#endif // ecCapsuleDistanceAlgorithm_H_
