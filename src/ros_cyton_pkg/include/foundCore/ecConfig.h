...
//
/// @file ecConfig.h
/// @brief Specify some global configuration parameters and values.
/// @details import and export declarations for building shared libs on win32.
//
//------------------------------------------------------------------------------
...
#if defined(WIN32)
/// dll imports storage-class modifier 
#  define EC_DECL_IMPORTS __declspec(dllimport) 
/// dll exports storage-class modifier 
...
#    include <crtdbg.h>
///  debug flags
#    define EC_DEBUG_FLAGS _CrtSetDbgFlag(_CRTDBG_ALLOC_MEM_DF|_CRTDBG_LEAK_CHECK_DF) 
#else
/// debug flags
#    define EC_DEBUG_FLAGS    
#endif
...
#  define EC_DECL_IMPORTS   ///<  imports storage-class modifier 
#  define EC_DECL_EXPORTS   ///<  exports storage-class modifier 
#  define EC_DEBUG_FLAGS    ///<  debug flags
...
#    define EC_STABLE_FOUNDCORE_PRETEMPLATE_DECL  extern      ///< Pre template declaration
#  else
#    define EC_STABLE_FOUNDCORE_DECL              EC_DECL_IMPORTS
#    define EC_STABLE_FOUNDCORE_PRETEMPLATE_DECL              ///< Pre template declaration
#  endif
